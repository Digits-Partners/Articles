...
A couple of algorithms maight be used to solve this optimization problem:
 ...
 P({Y<sup>\<1\></sup>,..., Y<sup>\<T<sub>y</sub>\>-1</sup>}  / X) =  P({Y<sup>\<1\></sup>,..., Y<sup>\<T<sub>y</sub>\>-1</sup>} / X) x P(Y<sup>\<T<sub>y</sub>\></sup> / X, {Y<sup>\<1\></sup>,..., Y<sup>\<T<sub>y</sub>\>-1</sup>}=[{uplet1}, {uplet2}, {uplet3}]), where Y<sup>\<T<sub>y</sub>\></sup> is ditributed among the T<sub>x</sub> words in the text corpus.
